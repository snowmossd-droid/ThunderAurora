...
public class PVPResources extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
            ...
            Render2DEngine.horizontalGradient(context.getMatrices(), getPosX() + 2, getPosY() + 24.5f, getPosX() + 26, getPosY() + 25, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
            Render2DEngine.horizontalGradient(context.getMatrices(), getPosX() + 26, getPosY() + 24.5f, getPosX() + 48, getPosY() + 25, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
            Render2DEngine.verticalGradient(context.getMatrices(), getPosX() + 25.5f, getPosY() + 2, getPosX() + 26, getPosY() + 23, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
            Render2DEngine.verticalGradient(context.getMatrices(), getPosX() + 25.5f, getPosY() + 23, getPosX() + 26, getPosY() + 48, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
        }
        ...
        for (int i = 0; i < list.size(); ++i) {
            ...
            FontRenderers.sf_medium.drawCenteredString(context.getMatrices(), String.valueOf(list.get(i).getCount()), (int) (getPosX() + offsetX + 12), (int) (getPosY() + offsetY + 11f), HudEditor.getColorInt(0));
