package acore.aurora.gui.windows;
...
public class WindowBase {
    protected static final Color WIN_BG          = new Color(0xC5333333, true);
    protected static final Color WIN_BORDER      = new Color(0xC55B5B5B, true);
    protected static final Color WIN_HOVER       = new Color(0xC5494949, true);
    protected static final Color WIN_TEXT        = new Color(0xBDBDBD);
    protected static final Color WIN_TEXT_BRIGHT = new Color(0xD5D5D5);
    ...
    protected void render(DrawContext context, int mouseX, int mouseY) {
        ...
        Render2DEngine.horizontalGradient(context.getMatrices(), x + 2, y + 16f, x + 2 + width / 2f - 2, y + 16.5f, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
        Render2DEngine.horizontalGradient(context.getMatrices(), x + 2 + width / 2f - 2, y + 16f, x + 2 + width - 4, y + 16.5f, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
