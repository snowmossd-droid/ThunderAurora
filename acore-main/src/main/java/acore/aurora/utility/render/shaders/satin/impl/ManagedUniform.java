...
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform1i;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform2f;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform2i;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform3f;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform3i;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform4f;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.Uniform4i;
import acore.aurora.utility.render.shaders.satin.api.managed.uniform.UniformMat4;
