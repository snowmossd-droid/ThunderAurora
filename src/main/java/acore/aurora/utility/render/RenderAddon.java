...
public class RenderAddon implements IMinecraft {
    ...
    public static void renderFakePlayer(Vec3d defensivePos, boolean fakelags, boolean isAccumulatingPackets, DrawContext render) {
        ...
        // renderFakePlayer requires MC 1.21.4+ render state API - not supported in 1.21
    }
        ...
        if (texture == null) {
            ...
            if (baseRenderer instanceof LivingEntityRenderer<?, ?, ?>) {
                ...
                try {
                    ...
                    texture = (Identifier) method.invoke(baseRenderer, living);
