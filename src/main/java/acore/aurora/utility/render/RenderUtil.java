...
import acore.aurora.utility.shader.ShaderManager;

import java.awt.*;

import static org.lwjgl.opengl.GL11C.GL_ONE;
import static acore.aurora.utility.math.MathUtil.interpolate;

@SuppressWarnings("All")
public class RenderUtil implements IMinecraft {
    private static final Supplier<SimpleFramebuffer> TEMP_FBO_SUPPLIER = Suppliers.memoize(() -> new SimpleFramebuffer(mc.getWindow().getFramebufferWidth(), mc.getWindow().getFramebufferHeight(), false, net.minecraft.client.MinecraftClient.IS_SYSTEM_MAC));
    ...
    private static void setShaderUniforms(ShaderProgram shader, float width, float height, Vector4f radius, float smoothness) {
        var __u_Size = shader != null ? shader.getUniform("Size") : null;
        if (__u_Size != null) shader.getUniform("Size").set(width, height);
        var __u_Radius = shader != null ? shader.getUniform("Radius") : null;
        if (__u_Radius != null) shader.getUniform("Radius").set(radius.x, radius.y, radius.z, radius.w);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(smoothness);
    }
    ...
    public static void drawRoundedBorder(MatrixStack matrices, float x, float y, float width, float height, Vector4f rounding, float thickness, int color) {
        ...
        if (__u_Size != null) shader.getUniform("Size").set(width, height);
        var __u_Radius = shader != null ? shader.getUniform("Radius") : null;
        if (__u_Radius != null) shader.getUniform("Radius").set(rounding.x, rounding.y, rounding.z, rounding.w);
        var __u_Thickness = shader != null ? shader.getUniform("Thickness") : null;
        if (__u_Thickness != null) shader.getUniform("Thickness").set(thickness);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(1.0f);
        ShaderManager.vertexShader(matrices, x, y, width, height, color);
        disableRender();
    }
    ...
    public static void drawBlur(MatrixStack matrices, float x, float y, float width, float height, Vector4f rounding, float blurRadius, int color) {
        ...
        if (fbo.textureWidth != mainFbo.textureWidth || fbo.textureHeight != mainFbo.textureHeight) {
            fbo.resize(mainFbo.textureWidth, mainFbo.textureHeight, net.minecraft.client.MinecraftClient.IS_SYSTEM_MAC);
        }
        ...
        if (__u_Radius != null) shader.getUniform("Radius").set(rounding.x, rounding.y, rounding.z, rounding.w);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(1f);
        var __u_BlurRadius = shader != null ? shader.getUniform("BlurRadius") : null;
        if (__u_BlurRadius != null) shader.getUniform("BlurRadius").set(blurRadius);
    ...
    public static void drawLiquidRect(MatrixStack matrices, float x, float y, float width, float height, Vector4f rounding, float cornerSmoothness, float fresnelPower, float fresnelAlpha, float baseAlpha, boolean fresnelInvert, float fresnelMix, float distortStrength, ColorRGBA color) {
        ...
        var __u_ModelViewMat = shader != null ? shader.getUniform("ModelViewMat") : null;
        if (__u_ModelViewMat != null) shader.getUniform("ModelViewMat").set(matrix4f);
        var __u_ProjMat = shader != null ? shader.getUniform("ProjMat") : null;
        if (__u_ProjMat != null) shader.getUniform("ProjMat").set(RenderSystem.getProjectionMatrix());
        var __u_Size = shader != null ? shader.getUniform("Size") : null;
        if (__u_Size != null) shader.getUniform("Size").set(width, height);
        var __u_Radius = shader != null ? shader.getUniform("Radius") : null;
        if (__u_Radius != null) shader.getUniform("Radius").set(rounding.x, rounding.y, rounding.z, rounding.w);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(1.0f);
        var __u_CornerSmoothness = shader != null ? shader.getUniform("CornerSmoothness") : null;
        if (__u_CornerSmoothness != null) shader.getUniform("CornerSmoothness").set(cornerSmoothness);
        var __u_GlobalAlpha = shader != null ? shader.getUniform("GlobalAlpha") : null;
        if (__u_GlobalAlpha != null) shader.getUniform("GlobalAlpha").set(color.getAlpha() / 255f);
        var __u_FresnelPower = shader != null ? shader.getUniform("FresnelPower") : null;
        if (__u_FresnelPower != null) shader.getUniform("FresnelPower").set(fresnelPower);
        var __u_FresnelColor = shader != null ? shader.getUniform("FresnelColor") : null;
        if (__u_FresnelColor != null) shader.getUniform("FresnelColor").set(1f, 1f, 1f);
        var __u_FresnelAlpha = shader != null ? shader.getUniform("FresnelAlpha") : null;
        if (__u_FresnelAlpha != null) shader.getUniform("FresnelAlpha").set(fresnelAlpha);
        var __u_BaseAlpha = shader != null ? shader.getUniform("BaseAlpha") : null;
        if (__u_BaseAlpha != null) shader.getUniform("BaseAlpha").set(baseAlpha);
        var __u_FresnelInvert = shader != null ? shader.getUniform("FresnelInvert") : null;
        if (__u_FresnelInvert != null) shader.getUniform("FresnelInvert").set(fresnelInvert ? 1 : 0);
        var __u_FresnelMix = shader != null ? shader.getUniform("FresnelMix") : null;
        if (__u_FresnelMix != null) shader.getUniform("FresnelMix").set(fresnelMix);
        var __u_DistortStrength = shader != null ? shader.getUniform("DistortStrength") : null;
        if (__u_DistortStrength != null) shader.getUniform("DistortStrength").set(distortStrength);
    ...
    public static void drawTexture(MatrixStack matrices, Object texture, float x, float y, float width, float height, float rounding, int color) {
        ...
        if (texture instanceof String path) {
            textureId = Identifier.of("acoreaurora", path);
        ...
        if (__u_Size != null) shader.getUniform("Size").set(width, height);
        var __u_Radius = shader != null ? shader.getUniform("Radius") : null;
        if (__u_Radius != null) shader.getUniform("Radius").set(rounding, rounding, rounding, rounding);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(1f);
    ...
    public static void drawCircleBorder(MatrixStack matrices, float centerX, float centerY, float diameter, float thickness, int color) {
        ...
        if (__u_Size != null) shader.getUniform("Size").set(diameter, diameter);
        var __u_Radius = shader != null ? shader.getUniform("Radius") : null;
        if (__u_Radius != null) shader.getUniform("Radius").set(radius, radius, radius, radius);
        var __u_Thickness = shader != null ? shader.getUniform("Thickness") : null;
        if (__u_Thickness != null) shader.getUniform("Thickness").set(thickness);
        var __u_Smoothness = shader != null ? shader.getUniform("Smoothness") : null;
        if (__u_Smoothness != null) shader.getUniform("Smoothness").set(1.0f);
