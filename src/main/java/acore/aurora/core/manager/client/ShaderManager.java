...
import acore.aurora.utility.render.shaders.satin.api.managed.ManagedShaderEffect;
...
import acore.aurora.features.modules.render.Shaders;
import acore.aurora.utility.interfaces.IShaderEffect;
...
public class ShaderManager implements IManager {
    ...
    private AcoreAuroraFramebuffer shaderBuffer;
    ...
    public void renderShaders() {
        if (DEFAULT == null) {
            shaderBuffer = new AcoreAuroraFramebuffer(mc.getFramebuffer().textureWidth, mc.getFramebuffer().textureHeight);
            reloadShaders();
        }
    ...
    public void reloadShaders() {
        DEFAULT = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/outline.json"));
        SMOKE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/smoke.json"));
        GRADIENT = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/gradient.json"));
        SNOW = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/snow.json"));
        FADE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/fade.json"));

        FADE_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/fade.json"), managedShaderEffect -> {
        ...
        DEFAULT_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/outline.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        SMOKE_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/smoke.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        GRADIENT_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/gradient.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        SNOW_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("acoreaurora", "shaders/post/snow.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
    ...
    public static class AcoreAuroraFramebuffer extends Framebuffer {
        public AcoreAuroraFramebuffer(int width, int height) {
            super(false);
            RenderSystem.assertOnRenderThreadOrInit();
