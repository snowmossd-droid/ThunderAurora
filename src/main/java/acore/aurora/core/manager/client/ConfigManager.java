...
public class ConfigManager implements IManager {
    public static final String CONFIG_FOLDER_NAME = "AcoreAurora";
    ...
    public static final File CRITSOUND_FOLDER = new File(MISC_FOLDER, "critsound");
    ...
    public ConfigManager() {
        ...
        createDirs(MAIN_FOLDER, CONFIGS_FOLDER, TEMP_FOLDER, MISC_FOLDER, SOUNDS_FOLDER, CRITSOUND_FOLDER, IMAGES_FOLDER, TABPARSER_FOLDER, STASHLOGGER_FOLDER);
    }
