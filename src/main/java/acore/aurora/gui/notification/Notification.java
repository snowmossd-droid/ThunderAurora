package acore.aurora.gui.notification;
...
import static acore.aurora.core.manager.client.NotificationManager.isDefault;
    ...
    public void render(MatrixStack matrix, float getY) {
        ...
        if (isDefault()) {
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Glowing)) {
                Render2DEngine.verticalGradient(matrix, x + 25, y + 1, x + 25.5f, y + 12, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
                Render2DEngine.verticalGradient(matrix, x + 25, y + 11, x + 25.5f, y + 22, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
            } else {
            ...
            FontRenderers.sf_bold_mini.drawString(matrix, title, x + 30, y + 6, HudEditor.getColorInt(0));
