...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) AcoreAurora.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(AcoreAurora.copy_color == null ? getColorSetting().getColorObject() : AcoreAurora.copy_color);
    }
