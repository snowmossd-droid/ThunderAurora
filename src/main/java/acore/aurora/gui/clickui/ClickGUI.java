...
import acore.aurora.core.manager.ClientManager;
import acore.aurora.core.manager.IMinecraft;
import acore.aurora.core.manager.Manager;
import acore.aurora.core.manager.themeManager.Style;
import acore.aurora.features.modules.Function;
import acore.aurora.features.modules.Type;
import acore.aurora.gui.clickui.setting.*;
import acore.aurora.protect.AES;
import acore.aurora.gui.clickui.impl.*;
import acore.aurora.gui.clickui.search.SearchState;
import acore.aurora.utility.animations.impl.EaseInOutQuad;
import acore.aurora.utility.color.ColorUtil;
import acore.aurora.gui.font.FontUtils;
import acore.aurora.utility.math.MathUtil;
import acore.aurora.utility.render.RenderAddon;
import acore.aurora.utility.render.RenderUtil;
import acore.aurora.utility.render.Scissor;
import acore.aurora.utility.render.providers.ResourceProvider;
import java.awt.*;
import java.util.*;

import static acore.aurora.utility.render.RenderUtil.drawBlur;
...
public class ClickGUI extends Screen implements IMinecraft {
    ...
    public final EaseInOutQuad imageAnimation = new EaseInOutQuad(500, 1);
    ...
    private void renderPanel(DrawContext ctx, int x, int y, Type category, int mouseX, int mouseY) {
        ...
        if (FontUtils.sf_bold[20] == null || FontUtils.icomoon[20] == null) return;
        ...
        for (Function f : Manager.FUNCTION_MANAGER.getFunctions(category)) {
            ...
            acore.aurora.features.modules.render.ClickGUI clickGUI = Manager.FUNCTION_MANAGER.clickGUI;
    ...
    private void renderSearchField(DrawContext ctx) {
        if (FontUtils.sf_medium[18] == null) return;
    ...
    private void renderExpiryText(DrawContext context) {
        if (FontUtils.durman[18] == null) return;
