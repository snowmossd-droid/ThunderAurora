...
public class ClickGUI extends Screen {
    ...
    private void renderPanel(DrawContext ctx, int x, int y, Module.Category cat, int mx, int my) {
        ...
        Render2DEngine.drawRound(ctx.getMatrices(), x - 1, y - 1, PANEL_WIDTH + 2, PANEL_HEIGHT + 2, PANEL_RADIUS + 1, new Color(255, 255, 255, 20));
        Render2DEngine.drawRound(ctx.getMatrices(), x, y, PANEL_WIDTH, PANEL_HEIGHT, PANEL_RADIUS, new Color(22, 26, 35, 235));
