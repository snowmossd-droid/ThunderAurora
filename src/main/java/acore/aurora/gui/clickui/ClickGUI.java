...
public class ClickGUI extends Screen {
    ...
    private void renderPanel(DrawContext ctx, int x, int y, Module.Category cat, int mx, int my) {
        ...
        Color border1 = ThemeManager.INSTANCE.getColorAlpha(270, 180);
        Color border2 = ThemeManager.INSTANCE.getColorAlpha(0, 180);
        Color border3 = ThemeManager.INSTANCE.getColorAlpha(180, 180);
        Color border4 = ThemeManager.INSTANCE.getColorAlpha(90, 180);
        Render2DEngine.drawGradientRound(ctx.getMatrices(), x - 1, y - 1, PANEL_WIDTH + 2, PANEL_HEIGHT + 2, PANEL_RADIUS + 1,
            border1, border2, border3, border4);

        Color bg1 = ThemeManager.INSTANCE.getColorAlpha(270, guiColor.getAlpha());
        Color bg2 = ThemeManager.INSTANCE.getColorAlpha(0, guiColor.getAlpha());
        Color bg3 = ThemeManager.INSTANCE.getColorAlpha(180, guiColor.getAlpha());
        Color bg4 = ThemeManager.INSTANCE.getColorAlpha(90, guiColor.getAlpha());
        Render2DEngine.drawGradientRound(ctx.getMatrices(), x, y, PANEL_WIDTH, PANEL_HEIGHT, PANEL_RADIUS,
            bg1, bg2, bg3, bg4);
        ...
        for (Module mod : Managers.MODULE.getModulesByCategory(cat)) {
            ...
            int cm1  = mod.isOn() ? ColorUtil.getColorStyle(30,  MODULE_BG_ALPHA) : new Color(198, 198, 198, MODULE_BG_ALPHA).getRGB();
