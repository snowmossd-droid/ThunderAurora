...
public class ClickGUI extends Screen {
    ...
    private void renderThemeButton(DrawContext ctx, int mx, int my) {
        ...
        {
            net.minecraft.client.render.RenderLayer layer = net.minecraft.client.render.RenderLayer.getGuiTextured(net.minecraft.util.Identifier.of("acoreaurora","textures/gui/elements/colors2.png"));
            ctx.drawTexture(r -> layer, net.minecraft.util.Identifier.of("acoreaurora","textures/gui/elements/colors2.png"), bx + 3, by + 2, 0, 0, 10, 10, 10, 10);
        }
    }
