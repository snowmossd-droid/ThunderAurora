...
public class ClickGUI extends Screen {
    ...
    private void renderThemeButton(DrawContext ctx, int mx, int my) {
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, colorsIcon, bx + 3, by + 3, 0, 0, 10, 10, 10, 10);
    }
    private void renderThemeRow(DrawContext ctx, int mx, int my) {
        ...
        if (pipsStartX + circleSize >= themeX && pipsStartX <= themeX + THEME_W) {
            ...
            if (selectedColor1 != -1 && selectedColor2 != -1) {
                ...
                ctx.drawTexture(RenderLayer::getGuiTextured, pipsId,
    ...
    private void renderColorPicker(DrawContext ctx, int mx, int my) {
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, pickId, p1x, p1y, 0, 0, p1s, p1s, p1s, p1s);
        ...
        ctx.drawTexture(RenderLayer::getGuiTextured, pickId, p2x, p2y, 0, 0, p2s, p2s, p2s, p2s);
