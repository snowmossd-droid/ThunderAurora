    ...
    public void onRender2D(DrawContext context) {
        ...
        for (Module module : list) {
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                Render2DEngine.drawRoundedBlur(context.getMatrices(), reverse ? reversedX - stringWidth : getPosX(), getPosY() + offset, stringWidth + 1.0f, 9.0f, 2, new java.awt.Color(0,14,37,255));
            } else {
