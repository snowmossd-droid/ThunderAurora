...
public class Cooldowns extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        if(HudEditor.hudStyle.is(HudEditor.HudStyle.Glowing)) {
            FontRenderers.sf_bold.drawCenteredString(context.getMatrices(), "Cooldowns", getPosX() + 50, getPosY() + 4, HudEditor.getColor(0));
        } else {
        ...
        if(HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
            ...
            Render2DEngine.horizontalGradient(context.getMatrices(), getPosX() + 2, getPosY() + 13.7f, getPosX() + 2 + 100 / 2f - 2, getPosY() + 14, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
            Render2DEngine.horizontalGradient(context.getMatrices(), getPosX() + 2 + 100 / 2f - 2, getPosY() + 13.7f, getPosX() + 2 + 100 - 4, getPosY() + 14, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
        }

        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Attack", getPosX() + 5, getPosY() + 20, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Hurt", getPosX() + 5, getPosY() + 30, HudEditor.getColorInt(0));
