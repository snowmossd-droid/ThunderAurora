...
import acore.aurora.features.modules.combat.AutoAnchor;
...
public class TargetHud extends HudElement {
    ...
    private final Setting<ModeEn> Mode = new Setting<>("Mode", ModeEn.AcoreAurora);
    ...
    public void onEnable() {
        try {
            ...
            sendMessage(".minecraft -> AcoreAurora -> misc -> images -> thud.png");
        }
    }
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (animation.getAnimationd() > 0) {
            ...
            switch (Mode.getValue()) {
                case AcoreAurora -> renderAcoreAurora(context, health, animationFactor);
    ...
    private void renderAcoreAurora(DrawContext context, float health, float animationFactor) {
        float hurtPercent = target.hurtTime / 6f;
    ...
    public enum ModeEn {
        AcoreAurora, NurikZapen, CelkaPasta
    }
}