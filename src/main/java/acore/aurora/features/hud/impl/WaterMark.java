    ...
    public void onRender2D(DrawContext context) {
        ...
        if (mode.getValue() == Mode.Big) {
            ...
            if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                ...
                Render2DEngine.drawRoundedBlur(context.getMatrices(), getPosX(), getPosY(), 50f, 15f, 3, new java.awt.Color(0,14,37,255));
                Render2DEngine.drawRoundedBlur(context.getMatrices(), getPosX() + 55, getPosY(), offset1 + offset2 - 36 + offset3, 15f, 3, new java.awt.Color(0,14,37,255));
                ...
                FontRenderers.sf_bold.drawString(context.getMatrices(), username, getPosX() + 68, getPosY() + 4.5f, HudEditor.getColorInt(0));
                FontRenderers.sf_bold.drawString(context.getMatrices(), (mc.isInSingleplayer() ? "SinglePlayer" : mc.getNetworkHandler().getServerInfo().address), getPosX() + offset1 + 13, getPosY() + 4.5f, HudEditor.getColorInt(0));
                Render2DEngine.endRender();
                ...
                FontRenderers.sf_bold.drawString(context.getMatrices(), info, getPosX() + 2 + FontRenderers.sf_bold.getStringWidth("Aurora "), getPosY() + 2.5f, HudEditor.getColorInt(0));
            ...
            FontRenderers.profont.drawString(context.getMatrices(), info, getPosX() + 2.7, getPosY() + 2.953, HudEditor.getColorInt(0));
