...
import acore.aurora.features.modules.combat.AutoCrystal;
...
public class AutoCrystalInfo extends HudElement {
    ...
    public void onRender2D(DrawContext context) {
        ...
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), max + "", getPosX() + 100, getPosY() + 16, HudEditor.getColorInt(0));

        if (!speeds.isEmpty())
            FontRenderers.sf_bold_mini.drawString(context.getMatrices(), speeds.getLast() + "", getPosX() + 100, getPosY() + 80 - (55f * ((float) speeds.getLast() / (float) max)), HudEditor.getColorInt(0));

        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), min + "", getPosX() + 100, getPosY() + 72, HudEditor.getColorInt(0));

        boolean isNull = ModuleManager.autoCrystal.getCurrentData() == null;

        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Target: " + Formatting.GRAY + (AutoCrystal.target == null ? "null" : AutoCrystal.target.getName().getString()), getPosX() + 113, getPosY() + 16, HudEditor.getColorInt(0));
        ...
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Calc delay: " + getCalcColor(calc) + calc + "ms", getPosX() + 113, getPosY() + 24, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Side: " + Formatting.GRAY + (isNull ? "null" : ModuleManager.autoCrystal.getCurrentData().bhr().getSide()), getPosX() + 113, getPosY() + 32, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Damage: " + Formatting.GRAY + (isNull ? "null" : MathUtility.round2(ModuleManager.autoCrystal.getCurrentData().damage())), getPosX() + 113, getPosY() + 40, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Self: " + Formatting.GRAY + (isNull ? "null" : MathUtility.round2(ModuleManager.autoCrystal.getCurrentData().selfDamage())), getPosX() + 113, getPosY() + 48, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Overr. dmg: " + Formatting.GRAY + (isNull ? "null" : ModuleManager.autoCrystal.getCurrentData().overrideDamage()), getPosX() + 113, getPosY() + 56, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Efficiency: " + getEfficiencyColor(efficiency) + efficiency, getPosX() + 113, getPosY() + 64, HudEditor.getColorInt(0));
        FontRenderers.sf_bold_mini.drawString(context.getMatrices(), "Pause: " + ModuleManager.autoCrystal.getPauseState(), getPosX() + 113, getPosY() + 72, HudEditor.getColorInt(0));
