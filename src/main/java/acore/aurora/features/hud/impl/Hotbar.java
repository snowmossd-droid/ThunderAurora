        ...
        if (playerEntity != null) {
            ...
            if (mc.player.getOffHandStack().isEmpty()) {
                ...
                if (HudEditor.hudStyle.is(HudEditor.HudStyle.Blurry)) {
                    ...
                    Render2DEngine.verticalGradient(matrices, i - 109 + 18, mc.getWindow().getScaledHeight() - 22 + 1 - 4, i - 108 + 18 - 0.5f, mc.getWindow().getScaledHeight() - 11 + 1 - 4, Render2DEngine.injectAlpha(HudEditor.getColor(0), 0), HudEditor.getColor(0));
                    Render2DEngine.verticalGradient(matrices, i - 109 + 18, mc.getWindow().getScaledHeight() - 11 - 4, i - 108 + 18 - 0.5f, mc.getWindow().getScaledHeight() - 5, HudEditor.getColor(0), Render2DEngine.injectAlpha(HudEditor.getColor(0), 0));
                }
            } else {
                Render2DEngine.drawHudBase(matrices, i - 90, mc.getWindow().getScaledHeight() - 25, 180, 20, HudEditor.hudRound.getValue());
