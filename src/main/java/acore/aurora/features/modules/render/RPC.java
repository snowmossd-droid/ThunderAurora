...
import acore.aurora.utility.discord.DiscordEventHandlers;
import acore.aurora.utility.discord.DiscordRPC;
import acore.aurora.utility.discord.DiscordRichPresence;
...
public final class RPC extends Module {
    ...
    public static void readFile() {
        try {
            File file = new File("AcoreAurora/misc/RPC.txt");
            if (file.exists()) {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            try {
                ...
                presence.largeImageText = "v" + AcoreAurora.VERSION + " [" + AcoreAurora.GITHUB_HASH + "]";
                    ...
                    try {
                        if (rpc != null) {
                            ...
                            switch (smode.getValue()) {
                                ...
                                case Version -> presence.state = "v" + AcoreAurora.VERSION +" for mc 1.21";
                            }
                            ...
                            presence.button_url_1 = "https://github.com/Pan4ur/AcoreAurora-Recode/";
