...
import acore.aurora.events.impl.EventSetting;
...
public class ClickGui extends Module {
    ...
    public ClickGui() {
        super("ClickGui", Module.Category.RENDER);
    }

    @Override
    public void onEnable() {
        if(pauseBaritone.getValue() && !fullNullCheck() && AcoreAurora.baritone){
    ...
    public enum Image {
        ...
        Image(String file, int fileWidth, int fileHeight, int[] pos, int size) {
            ...
            this.file = Identifier.of("acoreaurora", "textures/gui/images/" + file);
            this.pos = pos;
            this.size = size;
        }
    }
