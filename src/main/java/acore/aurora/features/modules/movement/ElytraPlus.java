...
import acore.aurora.features.modules.combat.Criticals;
...
import static acore.aurora.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final acore.aurora.utility.Timer startTimer = new acore.aurora.utility.Timer();
    private final acore.aurora.utility.Timer redeployTimer = new acore.aurora.utility.Timer();
    private final acore.aurora.utility.Timer strictTimer = new acore.aurora.utility.Timer();
    private final acore.aurora.utility.Timer pingTimer = new acore.aurora.utility.Timer();
