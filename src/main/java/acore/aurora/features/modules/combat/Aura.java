...
public class Aura extends Module {
    ...
    /** Trả về true nếu AntiCheat hiện tại cần resolver/backtrack mạnh hơn (AC dùng prediction). */
    ...
    /** Trả về true nếu AC hiện tại nhạy với spam click / cps cao (cần randomDelay mạnh hơn). */
