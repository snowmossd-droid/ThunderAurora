...
public class Aura extends Module {
    ...
    private void renderVisualsEsp(MatrixStack stack, Entity target) {
        ...
        for (FallingLine line : fallingLines) {
            ...
            buf.vertex(mat, 0f, 0f, 0f).color(lineColor.getRGB()).normal(stack.peek().getNormalMatrix(), normal.x, normal.y, normal.z);
            float lineLen = 0.8f + (line.maxLife - line.life) * 0.3f;
            buf.vertex(mat, 0f, lineLen, 0f).color(new Color(lineColor.getRed(), lineColor.getGreen(), lineColor.getBlue(), 0).getRGB()).normal(stack.peek().getNormalMatrix(), normal.x, normal.y, normal.z);
    ...
    public enum ESP {
        Off, AcoreAurora, NurikZapen, CelkaPasta, AcoreAuroraV2, Orbit, Spectre, Wraith, Rings, Visuals
    }
