...
public class AutoCrystal extends Module {
    ...
    /*   RENDER   */
    public final Setting<Aura.ESP> targetEsp = new Setting<>("TargetESP", Aura.ESP.CometRing, v -> page.is(Pages.Render));
    // espGroup/espLength/espFactor/espShaking/espAmplitude removed (AcoreAuroraV2 deleted)
    ...
    public void onRender3D(MatrixStack stack) {
        ...
        if (target != null) switch (targetEsp.getValue()) {
            ...
            case CometRing   -> ModuleManager.aura.renderCometRingEspPublic(target);
        }
