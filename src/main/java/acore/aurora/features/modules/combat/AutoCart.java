...
public class AutoCart extends Module {
   ...
   private final Setting<SettingGroup> bowSettings = new Setting<>("BowSettings", new SettingGroup(true, 0), v -> false);
   ...
   private final Setting<SettingGroup> crossbowSettings = new Setting<>("CrossbowSettings", new SettingGroup(true, 0), v -> false);
