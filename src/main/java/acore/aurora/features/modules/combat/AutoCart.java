...
public class AutoCart extends Module {
   ...
   private final Setting<Integer> startDelay  = new Setting<>("BowDelay",     25, 0, 60  ).addToGroup(bowSettings);
   private final Setting<Integer> drawDelay   = new Setting<>("DrawDelay",   600, 100, 2000).addToGroup(bowSettings);
   private final Setting<Integer> releaseDelay= new Setting<>("ReleaseDelay",100, 0, 500 ).addToGroup(bowSettings);
   private final Setting<Integer> delay       = new Setting<>("FireDelay",    25, 0, 100 ).addToGroup(bowSettings);
   private final Setting<Boolean> bowPredict  = new Setting<>("Predict",     false       ).addToGroup(bowSettings);
   private final Setting<Float>   bowForce    = new Setting<>("Force",       1f, 0.1f, 1f).addToGroup(bowSettings);
   ...
   private final Setting<Integer> cbDelay     = new Setting<>("CBDelay",      50, 0, 500  ).addToGroup(crossbowSettings);
   private final Setting<Integer> cbLoadDelay = new Setting<>("LoadDelay",   600, 100, 3000).addToGroup(crossbowSettings);
   private final Setting<Boolean> cbAutoLoad  = new Setting<>("AutoLoad",    true          ).addToGroup(crossbowSettings);
   private final Setting<Boolean> cbPredict   = new Setting<>("CBPredict",   false         ).addToGroup(crossbowSettings);
