...
import acore.aurora.core.hooks.ManagerShutdownHook;
import acore.aurora.core.hooks.ModuleShutdownHook;
...
public class AcoreAurora implements ModInitializer {
    public static final ModMetadata MOD_META;

    public static final String MOD_ID = "acoreaurora";
    ...
    public void onInitialize() {
        ...
        EVENT_BUS.registerLambdaFactory("acore.aurora",
        ...
        LOGGER.info("[AcoreAurora] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
