...
import thunder.aurora.core.hooks.ManagerShutdownHook;
import thunder.aurora.core.hooks.ModuleShutdownHook;
...
public class ThunderAurora implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        EVENT_BUS.registerLambdaFactory("thunder.aurora",
        ...
        LOGGER.info("[ThunderAurora] Init time: {} ms.", System.currentTimeMillis() - initTime);
        initTime = System.currentTimeMillis();
