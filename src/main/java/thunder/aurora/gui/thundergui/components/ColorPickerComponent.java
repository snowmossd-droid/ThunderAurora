...
public class ColorPickerComponent extends SettingElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (copy_focused) ThunderAurora.copy_color = getColorSetting().getColorObject();
        if (paste_focused)
            setColor(ThunderAurora.copy_color == null ? getColorSetting().getColorObject() : ThunderAurora.copy_color);
    }
