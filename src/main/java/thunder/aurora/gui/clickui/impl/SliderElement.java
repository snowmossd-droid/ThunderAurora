...
import static thunder.aurora.core.manager.IManager.mc;
...
public class SliderElement extends AbstractElement {
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        if (listening)
            ThunderAurora.currentKeyListener = ThunderAurora.KeyListening.Sliders;
    ...
    public void keyTyped(int keyCode) {
        if (ThunderAurora.currentKeyListener != ThunderAurora.KeyListening.Sliders)
            return;
