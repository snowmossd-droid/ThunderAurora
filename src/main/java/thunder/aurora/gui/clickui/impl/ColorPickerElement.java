package thunder.aurora.gui.clickui.impl;

import net.minecraft.client.gui.DrawContext;
import net.minecraft.client.util.math.MatrixStack;
import thunder.aurora.ThunderAurora;
import thunder.aurora.gui.clickui.AbstractElement;
...
public class ColorPickerElement extends AbstractElement {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        boolean dark = Render2DEngine.isDark(ThunderAurora.copy_color);
        ...
        Render2DEngine.drawRect(matrixStack, x + 63f, y + 54f, 24, 7, ThunderAurora.copy_color);
    ...
    public void mouseClicked(int mouseX, int mouseY, int button) {
        ...
        else if (copyHovered) ThunderAurora.copy_color = getColorSetting().getColorObject();

        else if (pasteHovered) getColorSetting().setColor(ThunderAurora.copy_color.getRGB());
