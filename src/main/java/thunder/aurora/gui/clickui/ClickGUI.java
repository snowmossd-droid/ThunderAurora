package thunder.aurora.gui.clickui;
...
public class ClickGUI extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        Render2DEngine.drawRect(context.getMatrices(), 0, 0,
        ...
        if (!Objects.equals(currentDescription, "") && ModuleManager.clickGui.descriptions.getValue()) {
            float tw = FontRenderers.sf_medium.getStringWidth(currentDescription) + 10;
            float th = 13;
            float tx = mouseX + 9;
            float ty = mouseY + 6;
            Render2DEngine.drawHudBase(context.getMatrices(), tx, ty, tw, th, 1f, false);
            FontRenderers.sf_medium.drawString(context.getMatrices(), currentDescription, tx + 5, ty + 3, HudEditor.getColor(0).getRGB());
            currentDescription = "";
        }
