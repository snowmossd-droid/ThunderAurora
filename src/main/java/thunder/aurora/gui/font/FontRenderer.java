package thunder.aurora.gui.font;
...
import static thunder.aurora.utility.math.MathUtility.roundToDecimal;
...
public class FontRenderer implements Closeable {
    ...
    public static @NotNull Identifier randomIdentifier() {
        return Identifier.of("thunderaurora", "temp/" + randomString());
    }
