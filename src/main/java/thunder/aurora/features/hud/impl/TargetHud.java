package thunder.aurora.features.hud.impl;
...
import thunder.aurora.features.hud.HudElement;
import thunder.aurora.features.modules.client.HudEditor;
import thunder.aurora.features.modules.combat.Aura;
import thunder.aurora.features.modules.combat.AutoAnchor;
import thunder.aurora.features.modules.combat.AutoCrystal;
import thunder.aurora.features.modules.misc.NameProtect;
...
import thunder.aurora.utility.render.animation.EaseOutCirc;
...
public class TargetHud extends HudElement {
    ...
    private final Setting<ModeEn> Mode = new Setting<>("Mode", ModeEn.ThunderAurora);
    ...
    public void onEnable() {
        try {
            ...
            sendMessage(".minecraft -> ThunderAurora -> misc -> images -> thud.png");
        }
    }
    ...
    public void onRender2D(DrawContext context) {
        ...
        if (animation.getAnimationd() > 0) {
            ...
            switch (Mode.getValue()) {
                case ThunderAurora -> renderThunderAurora(context, health, animationFactor);
    ...
    private void renderThunderAurora(DrawContext context, float health, float animationFactor) {
        float hurtPercent = target.hurtTime / 6f;
    ...
    public enum ModeEn {
        ThunderAurora, NurikZapen, CelkaPasta
    }
}