...
import thunder.aurora.utility.discord.DiscordEventHandlers;
import thunder.aurora.utility.discord.DiscordRPC;
import thunder.aurora.utility.discord.DiscordRichPresence;
...
public final class RPC extends Module {
    ...
    public static void readFile() {
        try {
            File file = new File("ThunderAurora/misc/RPC.txt");
            if (file.exists()) {
    ...
    public void startRpc() {
        ...
        if (!started) {
            ...
            try {
                ...
                presence.largeImageText = "v" + ThunderAurora.VERSION + " [" + ThunderAurora.GITHUB_HASH + "]";
                    ...
                    try {
                        if (rpc != null) {
                            ...
                            switch (smode.getValue()) {
                                ...
                                case Version -> presence.state = "v" + ThunderAurora.VERSION +" for mc 1.21";
                            }
                            ...
                            presence.button_url_1 = "https://github.com/Pan4ur/ThunderAurora-Recode/";
