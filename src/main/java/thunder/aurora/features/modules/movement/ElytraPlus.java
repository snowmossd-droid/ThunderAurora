...
import thunder.aurora.features.modules.combat.Criticals;
...
import static thunder.aurora.features.modules.player.ElytraSwap.getChestPlateSlot;
...
public class ElytraPlus extends Module {
    ...
    private final thunder.aurora.utility.Timer startTimer = new thunder.aurora.utility.Timer();
    private final thunder.aurora.utility.Timer redeployTimer = new thunder.aurora.utility.Timer();
    private final thunder.aurora.utility.Timer strictTimer = new thunder.aurora.utility.Timer();
    private final thunder.aurora.utility.Timer pingTimer = new thunder.aurora.utility.Timer();
