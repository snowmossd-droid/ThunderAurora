...
import thunder.aurora.injection.accesors.IInteractionManager;
import thunder.aurora.features.modules.Module;
import thunder.aurora.setting.Setting;
import thunder.aurora.utility.interfaces.IEntity;
...
import static thunder.aurora.utility.player.MovementUtility.isMoving;
...
public class Speed extends Module {
    ...
    private thunder.aurora.utility.Timer elytraDelay = new thunder.aurora.utility.Timer();
    private thunder.aurora.utility.Timer startDelay = new thunder.aurora.utility.Timer();
    ...
    public void onSync(EventSync e) {
        ...
        if (mode.getValue() == Mode.MatrixJB) {
            ...
            if (MovementUtility.isMoving() && closeToGround && mc.player.fallDistance <= 0) {
                ...
                ThunderAurora.TICK_TIMER = matrixJBSpeed.getValue();
    ...
    public void modifyVelocity(EventPlayerTravel e) {
        if (mode.getValue() == Mode.GrimEntity && !e.isPre() && ThunderAurora.core.getSetBackTime() > 1000) {
        ...
        if ((mode.is(Mode.GrimEntity2) || mode.is(Mode.GrimCombo)) && !e.isPre() && ThunderAurora.core.getSetBackTime() > 1000 && MovementUtility.isMoving()) {
            int collisions = 0;
    ...
    public void onMove(EventMove event) {
        ...
        if (MovementUtility.isMoving()) {
            ThunderAurora.TICK_TIMER = useTimer.getValue() ? 1.088f : 1f;
