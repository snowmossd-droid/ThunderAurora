...
import thunder.aurora.features.hud.impl.*;
import thunder.aurora.features.modules.Module;
import thunder.aurora.features.modules.client.*;
import thunder.aurora.features.modules.combat.*;
import thunder.aurora.features.modules.misc.*;
import thunder.aurora.features.modules.movement.Timer;
import thunder.aurora.features.modules.movement.*;
import thunder.aurora.features.modules.player.*;
import thunder.aurora.features.modules.render.Particles;
import thunder.aurora.features.modules.render.*;
...
public class ModuleManager implements IManager {
    ...
    public static ThunderAuroraGui thunderHackGui = new ThunderAuroraGui();
    ...
    public void onLoad(String category) {
        try {
            ThunderAurora.EVENT_BUS.unsubscribe(unHook);
        ...
        modules.forEach(m -> {
            if (m.isEnabled() && (m.getCategory().getName().equalsIgnoreCase(category) || category.equals("none")))
                ThunderAurora.EVENT_BUS.subscribe(m);
        });
    ...
    public void onRender2D(DrawContext context) {
        ...
        ThunderAurora.core.onRender2D(context);
    }
    ...
    public void onUnload(String category) {
        modules.forEach(module -> {
            if (module.isEnabled() && (module.getCategory().getName().equalsIgnoreCase(category) || category.equals("none"))) {
                ThunderAurora.EVENT_BUS.unsubscribe(module);
    ...
    public void registerModule(Module module) {
        ...
        if (module.isEnabled())
            ThunderAurora.EVENT_BUS.subscribe(module);
    }
