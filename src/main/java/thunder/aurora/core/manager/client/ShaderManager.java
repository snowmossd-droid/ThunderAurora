...
import thunder.aurora.utility.render.shaders.satin.api.managed.ManagedShaderEffect;
import thunder.aurora.utility.render.shaders.satin.api.managed.ShaderEffectManager;
...
import thunder.aurora.features.modules.render.Shaders;
import thunder.aurora.utility.interfaces.IShaderEffect;
...
public class ShaderManager implements IManager {
    ...
    private ThunderAuroraFramebuffer shaderBuffer;
    ...
    public void renderShaders() {
        if (DEFAULT == null) {
            shaderBuffer = new ThunderAuroraFramebuffer(mc.getFramebuffer().textureWidth, mc.getFramebuffer().textureHeight);
            reloadShaders();
        }
    ...
    public void reloadShaders() {
        DEFAULT = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/outline.json"));
        SMOKE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/smoke.json"));
        GRADIENT = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/gradient.json"));
        SNOW = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/snow.json"));
        FADE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/fade.json"));

        FADE_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/fade.json"), managedShaderEffect -> {
        ...
        DEFAULT_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/outline.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        SMOKE_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/smoke.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        GRADIENT_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/gradient.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
        ...
        SNOW_OUTLINE = ShaderEffectManager.getInstance().manage(Identifier.of("thunderaurora", "shaders/post/snow.json"), managedShaderEffect -> {
            PostEffectProcessor effect = managedShaderEffect.getShaderEffect();
            if (effect == null) return;
    ...
    public static class ThunderAuroraFramebuffer extends Framebuffer {
        public ThunderAuroraFramebuffer(int width, int height) {
            super(false);
            RenderSystem.assertOnRenderThreadOrInit();
