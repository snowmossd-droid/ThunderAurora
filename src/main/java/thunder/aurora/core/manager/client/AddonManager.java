...
import thunder.aurora.api.IAddon;
...
public class AddonManager implements IManager {
    ...
    public void initAddons() {
        ...
        for (EntrypointContainer<IAddon> entrypoint : FabricLoader.getInstance().getEntrypointContainers("thunderaurora", IAddon.class)) {
            ...
            try {
                ...
                ThunderAurora.EVENT_BUS.registerLambdaFactory(addon.getPackage(), (lookupInMethod, klass) -> (MethodHandles.Lookup) lookupInMethod.invoke(null, klass, MethodHandles.lookup()));
