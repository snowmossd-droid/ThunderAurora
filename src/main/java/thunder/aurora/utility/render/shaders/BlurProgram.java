package thunder.aurora.utility.render.shaders;
...
import thunder.aurora.utility.render.WindowResizeCallback;
import thunder.aurora.utility.render.shaders.satin.api.managed.ManagedCoreShader;
import thunder.aurora.utility.render.shaders.satin.api.managed.ShaderEffectManager;
import thunder.aurora.utility.render.shaders.satin.api.managed.uniform.SamplerUniform;
...
public class BlurProgram {
    ...
    public static final ManagedCoreShader BLUR = ShaderEffectManager.getInstance()
            .manageCoreShader(Identifier.of("thunderaurora", "blur"), VertexFormats.POSITION);
