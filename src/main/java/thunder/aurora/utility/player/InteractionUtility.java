package thunder.aurora.utility.player;
...
import thunder.aurora.injection.accesors.IClientWorldMixin;
...
public final class InteractionUtility {
    ...
    public static void clickSlot(int inventorySlot, int hotbarSlot, SlotActionType actionType) {
        if (mc.interactionManager == null || mc.player == null) return;
        mc.interactionManager.clickSlot(mc.player.playerScreenHandler.syncId, inventorySlot, hotbarSlot, actionType, mc.player);
    }
